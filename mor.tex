...
is spin-independent, we may utilize RHF / UHF wave functions (\cref{sec:SpinSymm}) for the reference determinant. 
This will allow for significant simplification of the resulting expressions due to spin orthogonality \cite{Yeager84_33}.
