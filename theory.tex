...
the subject for a more thorough treatment of these matters \cite{Wolf15_book,Faegri07_book} \co{add more?}. There are, however, several
...
formulation, which have been shown to have good agreement with experiment \todo{cite exp benchmark, etc}.
...
In the absense of external fields , the DCB Hamiltonian for $N$ electrons is given in atomic units by \cite{Wolf15_book,Faegri07_book}
\begin{equation}
  \label{eq:DCBHam}
