...
single particle system: $\mathcal{H}^1$,\co{Needs more consideration, might just be a basis}
\begin{equation}
  \label{eq:SepHilbert}
...
\end{align}
\end{subequations}
%The identities outlined in \cref{eq:SlaterCondon,eq:DiracInts} will be used extensively in the subsequent developments.
