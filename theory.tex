...
Namely, if $\hilb{H}^1$ represents a non-relativistc spin--1/2 fermion, $\set{\ket{\vc{r},\sigma}}$ forms a complete basis for $\hilb{H}^1$ 
...
of the original Schr\"{o}dinger Hamiltoninan of the general form \cite{Napolitano17_book}
\begin{equation}
\label{eq:SchHam}
...
In the absense of external fields , the DC Hamiltonian for $N$ electrons is given in atomic units by \cite{Wolf15_book,Faegri07_book}
\begin{equation}
  \label{eq:DCHam}
