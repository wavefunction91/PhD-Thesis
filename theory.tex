...
\begin{equation}
\mathcal{L}[\mathcal{K}^N] = E^\mathrm{HF}[\mathcal{K}^N] - \sum_{i,j \in \mathcal{K}^N} \epsilon_{ij} \left( \inner{\phi_i}{\phi_j} - \delta_{ij} \right),
\end{equation}
where $\mathcal{K}^N$ is an arbitrary $N$ orbital configuration and $\epsilon_{ij}$ is a set of to--be--determined Lagrange multipliers
...
\begin{align}
&E^\mathrm{HF}[\mathcal{K}^N] = E[\gamma^1] = 2\sum_{K_1}\iint_{\mathbb R^3} 
  \delta^3(\vc{r}_1 - \vc{r}'_1) \left[\left( \op{h}^{K_1}(\vc{r}_1) + \op{v}^{K_1}(\vc{r}_1) \right) \gamma^{1,K}(\vc{r}'_1; \vc{r}_1)\right] \,\dd^3\vc{r}_1 \dd^3\vc{r}'_1 \,\,+ \nonumber\\
  &\quad 2\sum_{K_1K_2}
   \iint_{\mathbb{R}^3} \op{g}^{K_1K_2}(\vc{r}_1,\vc{r}_2) 
    \left( \gamma^{1,K_1}(\vc{r}_1; \vc{r}_1)\gamma^{1,K_2}(\vc{r}_2; \vc{r}_2) - \gamma^{1,K_1}(\vc{r}_1; \vc{r}_2)\gamma^{1,K_2}(\vc{r}_2; \vc{r}_1) \right) \,\dd^3\vc{r}_1 \dd^3\vc{r}_2.
\end{align}
\Cref{eq:ConstrMin} then becomes
\begin{equation}
  \int_\mathbb{F} \op{F}(\vc{x}; \vc{x}') \phi_i(\vc{x}') \dd^4\vc{x}' - \sum_{j \in \mathcal{K}^N} \epsilon_{ij} \phi_j(\vc{x}) = 0
\end{equation}
where
\begin{align}
&F(\vc{x}; \vc{x}') = \frac{\delta E^\mathrm{HF}[\gamma^1]}{\delta \gamma^1(\vc{x}'; \vc{x})} = H(\vc{x};\vc{x}') + J(\vc{x};\vc{x}') - K(\vc{x};\vc{x}') \\
&H(\vc{x}; \vc{x}') = \delta^4(\vc{x} - \vc{x}')
\end{align}
