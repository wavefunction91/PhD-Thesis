...
the block structure of the MO coefficients in \cref{eq:USCFEq}. To demonstrate the validity of this block diagonalization,
...
\begin{equation}
  \innerop{\Phi^N_0}{\op{S}_z}{\Phi^N_0} = Tr \left[ \vc P^3 \vc S \right] = \frac{N^\alpha - N^\beta}{2}
\end{equation}
...
determinant is resticted to have $N^\alpha \neq N^\beta$, or when the electronic Hamiltonian depends only on
