...
allows for drastic simplifications in the development of many--body theory as the hermeticity
...
various diagramatic techniques or explicitly by Wick's theorem \cite{Walecka12_book,Schuck04_book,Ohrn73_book} \todo{more cites}.
...
without primes, and visa versa. In analogy to \cref{eq:GenDenMatInner,eq:RDMSpinBasis}, we can define a second quantized analogue to
the 1RDM such that,
\begin{align}
  \label{eq:DenOpInner}
...
\begin{equation}
  \op{O}_\hilb{F}^1 = 2\sum_K \int_{\mathbb R^3} 
    ...
    \,\dd^3 \vc{r}_1,
\end{equation}
where we have defined an analogy to the Pauli compoenents of the spinor density as
...
of single Slater determinants, all of resulting arithmetic can be done in terms of the 1RDM and analogus
